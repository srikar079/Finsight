...
function App() {
  ...
  useEffect(() => {
    const url = 'https://stock.indianapi.in/stock?name=Tata+Steel';
    const options = {
      method: 'GET',
      headers: {
    ...
    const fetchData = async () => {
      try {
        ...
        // Destructure the result to exclude financials
        const { 
          financials, 
          stockFinancialData, 
          ...
          <div className="space-y-6">
            ...
            <section>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p><span className="font-medium">Standard Deviation:</span> {data?.riskMeter?.stdDev.toFixed(2)}</p>
              </div>
            </section>
